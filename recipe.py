# Skills Utilized: Lists, dictionaries, user input/output, file handling for storing recipes.
...
def main():
    ...
    while (x == 'n' or x=='o'):
        if x == 'n':
            ...
            x = input('What you wanna do now? (N or O)')
        elif x == 'o':
